...
> **ЗАМЕТКА!** Получающаяся сложность наивного решения - O(N \* M), в то
...
*Бинарный (двоичный) поиск* (binary search, метод бисекции, bisection) -
поиск посредством разделения отрезка пополам до тех пор, пока не будет
выполнено условие нахождения нужного элемента.
...
*Сортировка событий* (event sort) то не столько алгоритм, сколько подход
к решению задач. Суть заключается в отношении к полученным данным как к
событиям, где это уместно, и их последующая обработка.
...
*Жадный алгоритм* (greedy) - действуем наилучшим образом на данный
момент, не задумываясь о будущем.
...
*Алгоритм Хаффмана* (Haffman's algorithm) - жадный алгоритм оптимального
...
*Мультимножество* - множество, куда один эл-т может входить несколько
раз.
...
на текущий эл-т (для последующего удаления/вставки не в конец или начало
или других целей).
...
содержать указатель на текущий эл-т (для последующего удаления/вставки
не в конец или начало или других целей).
