...
- **!=** - не равно.
- **(!)** - заострить внимание, восклицание.
- **(?)** - неточно, проверить.
- **:=** - присвоение (приравнивание) значения.
- **:)**, **;)**.
- **=**, **==** - равно, равняется.
- **=>** - следовательно.
- **<** - меньше.
- **<>** - не равно.
- **>** - больше.
- **<=** - "что следует из" (обратное следование) или "меньше или
    равно".
- **>=** - больше или равно.
...
- **имхо** - по моему честному мнению, ИМХО, IMHO.
- **инт-л** - интервал.
...
- **WSGI** - Web Server Gateway Inerface.
- **WWW** - World Wide Web.
